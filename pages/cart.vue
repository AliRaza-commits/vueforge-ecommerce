...
async function handleCheckout() {
  let res = await $fetch("/api/cart",{
    ...
    body:{product: cartStore.products} 
    });
      ...
      <div class="md:w-3/4">
        ...
        <div v-else class="overflow-x-auto">
          <div class="table w-full">
                      ...
                      <div class="avatar">
                        <div class="mask mask-squircle w-12 h-12">
                          <img
                            ...
                            :alt="product.fields.image[0].fields.file.title"
                          />
                        </div>
                      </div>
                    </div>
            ...
            <button v-if="selected.length" @click="cartStore.removeProducts(selected),selected = [];" class="text-sm text-red-500">
              Remove Selected
            </button>
          </div>
        </div>
